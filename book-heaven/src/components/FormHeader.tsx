const FormHeader = ({title,description}: {title: string, description: string}) => {
  ...
  className="w-full flex bg-stone-200 shadow-lg border-4 border-slate-300 items-center justify-center p-2 rounded-lg gap-2 cursor-pointer duration-300 hover:scale-105 transition-all hover:bg-slate-300"
>
