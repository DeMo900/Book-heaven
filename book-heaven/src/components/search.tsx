...
<input className="bg-[#F5F3EF] rounded-r-2xl w-full h-12 outline-none " type="text" placeholder="Search the collection" value={search} onChange={(e) => setSearch(e.target.value)} />
</div>
    )
}
