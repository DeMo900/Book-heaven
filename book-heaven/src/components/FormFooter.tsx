...
const FormFooter = ({instructions,buttonText,error}:FormFooterProps) => {
    return (
        ...
        <p className="text-center text-red-500 cursor-pointer">{error}</p>
            <button className="bg-[#1B3B5A] block text-white w-full h-14 rounded-lg gap-2 cursor-pointer duration-300 hover:scale-105 transition-all hover:bg-[#1B3B5A]/90" type="submit">{buttonText}</button>
