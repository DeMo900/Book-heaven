...
const Search = ({onChange,onFocus,isTopNavVisible,typeMode}:props) => {
return (
<div className={`flex md:ml-24 shadow-lg w-[90%] md:w-[50%] bg-blue-200 justify-end rounded-2xl focus-within:ring-3 focus-within:ring-slate-300`}>
