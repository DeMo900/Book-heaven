...
const ForgotPassword = () => {
    ...
    return (
        ...
        <FormHeader title="Forgot Password" description="Enter your email address and we will send you the reset link." resetPassword={true} />
      ...
      <FormFooter buttonText="Send me the verfication email" instructions="" error={error} />
        </div>
        </form>
        </div>
    )
