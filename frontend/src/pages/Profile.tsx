    ...
    <div>
      ...
      <div className="flex flex-col w-full md:items-end px-4 items-center justify-center pt-33">
        <div className="flex flex-col items-center md:items-end justify-center gap-4 ">
          <h1 className="text-[#002542] font[Inter] font-semibold text-6xl">
            {user.username}
          </h1>
          <p className="text-slate-950 font-[Inter] flex items-center gap-2">
            <Mail className="text-slate-600" size={20} />
            {user.email}{" "}
          </p>
        </div>
        <div className="flex flex-col md:items-start md:p-2 md:gap-4 items-center w-full mt-8 ">
          <h1 className="text-[#002542]  font[Inter]  font-semibold text-4xl my-2">
            Your Rotation
          </h1>
