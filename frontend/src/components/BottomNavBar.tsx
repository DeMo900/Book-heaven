...
const BottomNavBar = () => {
  ...
  return (
    <div className="flex bg-stone-200 fixed items-center md:hidden justify-between bottom-0 w-full h-24">
      ...
      >
        <Library
          className={`w-8 h-8 ${location.pathname === "/library" ? "text-green-400/50" : "text-[#486459]"}`}
        />
      ...
      >
        <Search
          className={`w-8 h-8 ${location.pathname === "/" ? "text-green-400/50" : "text-[#486459]"}`}
        />
      ...
      >
        <User
          className={`w-8 h-8 ${location.pathname === "/profile" ? "text-green-400/50" : "text-[#486459]"}`}
        />
      ...
      >
        <Star
          className={`w-8 h-8 ${location.pathname === "/curated" ? "text-green-400/50" : "text-[#486459]"}`}
        />
