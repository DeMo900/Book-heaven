...
const Input = ({labelName,labelValue,type,placeholder}:InputProps) => {
    return (
     ...
     {type === "password" && labelName === "password" && <p className="text-xs text-blue-950 cursor-pointer">Forgot Password?</p>}
        ...
        <input className="bg-stone-200 py-3 px-6 w-[95%] h-14 rounded-lg gap-2 mx-auto" type={type} placeholder={placeholder} />
